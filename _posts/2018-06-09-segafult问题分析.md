...
配置 core dump 文件大小限制，生成 core 文件，`gdb`调试，`backtrce`查看call stacks。
...
![addr2line.png](https://raw.githubusercontent.com/kgbook/kgbook.github.io/master/images/addr2line.png "addr2line.png")
