...
![objdump section.png](https://raw.githubusercontent.com/kgbook/kgbook.github.io/master/images/segfault-sample-objdump.png "objdump section.png")

`kang $ size -x -l -m a.out`

目标文件各section布局：

![section size.png](https://raw.githubusercontent.com/kgbook/kgbook.github.io/master/images/segfault-sample-section-size.png "section size.png")
