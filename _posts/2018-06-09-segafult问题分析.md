...
![objdump section.png][segfault-objdump-section-img]

[segfault-sample-objdump](https://github.com/kgbook/kgbook.github.io/blob/master/images/segfault-sample-objdump.png "objdump section.png")

`kang $ size -x -l -m a.out`

目标文件各section布局：

![section size.png][segfault-section-size.png]

[segfault-sample-section-size](https://github.com/kgbook/kgbook.github.io/blob/master/images/segfault-sample-section-size.png "section size.png")
